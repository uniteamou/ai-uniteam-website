...
const reasons = [
  { icon: <Zap className="w-4 h-4 text-violet-400" />, text: "Free 30-min AI audit" },
  { icon: <Clock className="w-4 h-4 text-blue-400" />, text: "Response within 24h" },
  { icon: <Check className="w-4 h-4 text-emerald-400" />, text: "No commitment required" },
];
      ...
      <section className="py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <p className="text-zinc-400" style={{ fontSize: "1.1rem", lineHeight: 1.7 }}>
            Tell us what you're working on. We'll identify automation opportunities and show you what's possible.
          </p>
          <div className="flex items-center justify-center gap-6 mt-6 flex-wrap">
            {reasons.map((r) => (
              <div key={r.text} className="flex items-center gap-2 text-zinc-400" style={{ fontSize: "0.85rem" }}>
                {r.icon} {r.text}
              </div>
            ))}
          </div>
            ...
            <div className="p-8 rounded-3xl border border-zinc-800 bg-zinc-900/50">
              {formState === "error" ? (
                <div className="flex flex-col items-center text-center py-12">
                  ...
                  <h3 className="text-white mb-3" style={{ fontWeight: 800, fontSize: "1.4rem" }}>
                    Something went wrong
                  </h3>
                  <p className="text-zinc-400 mb-2" style={{ fontSize: "0.95rem", lineHeight: 1.7 }}>
                    We couldn't send your message. Please try again or reach us directly at:
                  </p>
                  <a href="mailto:uniteamou@protonmail.com" className="text-violet-400 hover:text-violet-300 transition-colors" style={{ fontSize: "0.95rem" }}>
                ...
                <div className="flex flex-col items-center text-center py-12">
                  ...
                  <p className="text-zinc-400" style={{ fontSize: "0.95rem", lineHeight: 1.7 }}>
                    We'll review your project and get back to you within 24 hours. Keep an eye on your inbox!
                  </p>
                  <button
                    onClick={() => { setFormState("idle"); setForm({ name: "", email: "", company: "", message: "", interest: "" }); }}
                    className="mt-8 px-6 py-2.5 rounded-xl border border-zinc-700 text-zinc-400 hover:text-white hover:border-zinc-500 transition-all"
                    style={{ fontSize: "0.9rem", fontWeight: 600 }}
                  >
                ...
                <>
                  <div className="flex items-center gap-3 mb-7">
                    ...
                    <div>
                      <h2 className="text-white" style={{ fontWeight: 700, fontSize: "1.1rem" }}>Send us a message</h2>
                      <p className="text-zinc-500" style={{ fontSize: "0.8rem" }}>We respond within 24 hours</p>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-zinc-400 mb-1.5" style={{ fontSize: "0.82rem", fontWeight: 600 }}>
                          Name *
                        </label>
                        <input
                          type="text"
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="AI Assistants" className="bg-zinc-900">AI Assistants</option>
                        <option value="AI Automation" className="bg-zinc-900">AI Automation</option>
                        <option value="Custom AI Tools" className="bg-zinc-900">Custom AI Tools</option>
                        <option value="Free AI Audit" className="bg-zinc-900">Free AI Audit</option>
                        <option value="Something else" className="bg-zinc-900">Something else</option>
                      </select>
                    </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* <div className="p-8 rounded-3xl border border-zinc-800 bg-zinc-900/50">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-white" style={{ fontWeight: 700, fontSize: "1.1rem" }}>Book a call</h2>
                  <p className="text-zinc-500" style={{ fontSize: "0.8rem" }}>30 minutes · Free · No commitment</p>
                </div>
              </div>

              <p className="text-zinc-400 mb-6" style={{ fontSize: "0.9rem", lineHeight: 1.7 }}>
                Pick a slot and we'll hop on a video call to discuss your project, answer questions, and identify where AI automation could help.
              </p>
              ...
              <button
                onClick={() => selectedSlot && alert(`Call booked for ${selectedSlot}! We'll send a confirmation email.`)}
                disabled={!selectedSlot}
                className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-violet-600 text-white hover:bg-violet-500 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
            ...
            <div className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/50">
              <p className="text-zinc-400 mb-4" style={{ fontSize: "0.85rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em" }}>
                Direct contact
              </p>
              <a
              ...
              >
                ...
                <span style={{ fontSize: "0.9rem" }}>uniteamou@protonmail.com</span>
              </a>
            </div>
            ...
            <div className="p-6 rounded-2xl border border-zinc-800 bg-zinc-900/50">
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  { step: "3", text: "We prepare a tailored automation proposal" },
                  ...
                  <div key={item.step} className="flex items-center gap-3">
                    ...
                    <p className="text-zinc-400" style={{ fontSize: "0.88rem" }}>{item.text}</p>
                  </div>
                ))}
              </div>
            </div>
