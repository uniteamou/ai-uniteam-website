...
export const Icons = {
  ...
  logo: (props: IconProps) => (
    ...
    >
      <defs>
        <clipPath id="a">
          <path d="M86.2 44.797h211.5v294.75H86.2Zm0 0" />
        </clipPath>
      </defs>
      <g clipPath="url(#a)">
        <path d="M297.547 128.816c.117 46.555-37.66 84.47-84.11 84.47h-45.82c-19.863 0-35.969 16.132-35.969 36.03v46.38l-43.785 43.85v-78.882c0-50.383 40.778-91.234 91.086-91.234h34.496c22.176 0 40.235-18.024 40.328-40.227.09-22.305-18.316-40.558-40.593-40.558h-83.164L86.234 44.797h126.809c46.422 0 84.383 37.52 84.504 84.02m0 0" />
      </g>
    </svg>
  ),
};
